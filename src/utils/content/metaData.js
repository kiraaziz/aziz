  ...
  home: {
    about: {
      ...
      description: [
        ...
        `<br /> 3+ years' experience and 60k+ reads on<a href="https://dev.to/kiraaziz" class="text-primary hover:underline mx-1" target="_blank" rel="noopener noreferrer">dev.to</a>`,
